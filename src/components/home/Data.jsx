...
const Data = () => {
  return (
    ...
    <div className="home__data">
        <h1 className="home__title"> Vitor Latorraca
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
                ...
                <p className="home__description"> I am a computer programming student looking for a co-op position that allows me to improve my knowledge.</p>
